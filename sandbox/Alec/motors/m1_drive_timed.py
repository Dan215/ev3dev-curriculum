...
def main():
    ...
    while time_s != 0:
        ...
        if distance == 0:
            break
        left_motor.run_forever(speed_sp=speedy)
        right_motor.run_forever(speed_sp=speedy)
        time.sleep(1/((speed*0.113)/distance))
        left_motor.stop()
