...
def main():
    ...
    back_button['command'] = lambda: go_back(mqtt_client, left_speed_entry, right_speed_entry)
    root.bind('<Back>', lambda event: go_back(mqtt_client, left_speed_entry, right_speed_entry))
...
# TODO: 4. Implement the functions for the drive button callbacks.
    def go_forward(self, left_speed_entry, right_speed_entry):
        left = left_speed_entry.get()
        right = right_speed_entry.get()
        robot.right_motor
