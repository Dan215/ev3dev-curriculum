...
#     slope is 1.130 inches/degree/second
#
...
def main():
    ...
    while time_s != 0:
        speed=int(input("Enter a speed for the robot (0 to 900 dps):"))
        Dist=int(input("Enter a distance for the robot to go (0 to 100 inches)"))
        left_sp = speed
        right_sp = speed
        time_s = Dist/0.0113/speed
