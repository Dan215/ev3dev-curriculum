...
Authors: David Fisher and Daniel Johnson.
...
def main():
    ...
    print("  Timed Driving")
    print("--------------------------------------------")
    ev3.Sound.speak("Timed Driving error error eerrroooooor eeeerererrrrrroororoooooooooorrrororor").wait()
    ...
    while time_s != 0:
        ...
        if(speed == 0 or distance == 0):
            break;
        m = .0113
        speed_in_inches_per_second = m * speed
